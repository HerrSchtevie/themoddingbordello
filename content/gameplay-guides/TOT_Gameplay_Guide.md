...
- Once you enter the game:
  ...
  - A **TOT Welcome message** will pop up immediately — this explains that the list is performing initial setup in the background and that **you must wait**.
...
Whether you're a seasoned modlist veteran or totally new to modern Skyrim overhauls, TOT is designed to feel intuitive, stable, and rewarding from the very first load screen.
