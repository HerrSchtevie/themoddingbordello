...
* While you are still in RaceMenu the list is already configuring its own MCMs in the background. There is nothing for you to run. A popup reading **"Hymns of Hircine MCM configuration complete."** appears when it has finished, often before you have left this screen. Dismiss it and carry on; it only shows once.
...
- Open the MCM again and check the settings below. The list ships them pre-set, so you should only need to correct anything that differs.
...
- [MCO](https://www.nexusmods.com/skyrimspecialedition/mods/175044)
...
**Hymns of Hircine** uses **[Shadow of Skyrim - Nemesis and Alternative Death System](https://www.nexusmods.com/skyrimspecialedition/mods/65136)** by default.
