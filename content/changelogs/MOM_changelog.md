...
- Added/edited the following custom patches: 
   ...
   - `MOM - MCM and INI Settings` - VSync is now on by deafult in `ssedisplaysettings.ini`  
...
[Submissive Lola Resubmission](https://www.loverslab.com/files/file/15346-submissive-lola-the-resubmission-lese/)  
...
The Lord's Vision (ENB) profile is gone. MOM now ships a single Community Shaders profile, `Mantras of Mara`, and the Lord's Vision tool outputs went with it. ENB presets are still available through Effects 11; see `ENB Presets and DLSS 5 - Setup Instructions` in MO2.
...
- Added/edited the following custom patches: 
   ...
   - `MOM - Cell and Worldspace Edits`  
   - `MOM - Gameplay Edits`  
   - `MOM - BHKS Lux Patch` - Thanks, [Rynfri](https://www.nexusmods.com/profile/Rynfri)!  
...
[Sex Animation Framework v1.66c](https://www.loverslab.com/files/file/20058-sexlab-se-sex-animation-framework-v166c-08252026/) - Requires new manual download from [MOM Manual Downloads](https://www.themoddingbordello.com/modlists/mom/manual-downloads)  
...
[Alpia Slavetats SE (06.2026)](https://www.loverslab.com/files/file/30951-alpia-scribbles-slavetats-pack/)  
[Alpia Racemenu Plugins (06.2026)](https://www.loverslab.com/files/file/30951-alpia-scribbles-slavetats-pack/)  
[SLAL_Billyy_Animations v10.3 SE](https://www.loverslab.com/files/file/3999-billyys-slal-animations-2026-6-4/)  
...
- Rebuilt `MOM - BodySlide Output` to fix some Devious Devices issues
...
[HOUSE OF WARRIORS - Immersive Dialogue Expansion - Jorrvaskr (Companions)](https://www.nexusmods.com/skyrimspecialedition/mods/173134)  
[PSBoss Standing Stones AIO with New Fixes](https://www.nexusmods.com/skyrimspecialedition/mods/174543)  
[PSBoss Standing Stones AIO - Compatibility Patches](https://www.nexusmods.com/skyrimspecialedition/mods/175014)  
[PSBoss Standing Stones AiO - LotD display Fix 1.0.0](https://www.loverslab.com/files/file/47795-psboss-standing-stones-aio-lotd-display-fix/)  
...
[Skyrim Outfit Equipment System NG](https://www.nexusmods.com/skyrimspecialedition/mods/147011) - unfortunately does not play well with Devious Devices  
[Wet Function Redux SE compatibility for Skyrim Outfit System](https://www.nexusmods.com/skyrimspecialedition/mods/89585)  
...
## Tweaks
- Added/edited the following custom patches
   - `MOM - TRX Futanari BNP Frostnip textures`  
   - `JOJ - Outfits.esp`  
   - `MOM - Chloe's Aroused Patch.esp` - Thanks, Chloe!  
   - `SOS - Gameplay Edits.esp` 
   - `SOS - Late Loaders.esp`  
   - `SOS - Landscape Patch - The Rift.esp`  
- Added custom werewolf transformation scripts into `SOS - Merged Patches` - Thanks, Rynfri!  
- Updated `MOM - Armour WAAT Patch 5.esp` to correct misassignment of Adventurer's Tunic crafting recipes  
- Fixed issues with OBody not working with certain BD's Armor replacers  
- Added VRAMr `Exclusions.mod` to `MOM - MCM and INI Settings` and added in Vampire Lord Overhaul textures that cause issues when run through VRAMr  
- Patched out Jarrin Root spawning gratuitously in JK's Hag's Cure and JK's Dark Brotherhood Sanctuary  

---

# MOM 2.1.1 (Updated - 03.14.2026)
...
- Fixed [VRAMr](<https://www.nexusmods.com/skyrimspecialedition/mods/90557?tab=files>) executable to correct pathing  
- Re-cropped main menu video

---

# MOM 2.1.0 (Updated - 03.13.2026)
...
[Tailor - An Outfit and Wig Manager](https://www.nexusmods.com/skyrimspecialedition/mods/173691) Thanks, [Coldsun](https://www.nexusmods.com/profile/coldsun1187)!  
[Main Menu Video](https://www.nexusmods.com/skyrimspecialedition/mods/160238)  
[PAIA Expansion conversion for Fertility Mode Reloaded](https://www.nexusmods.com/skyrimspecialedition/mods/169023)  
...
- Added back `SOS - S7 Customization Facegen` with some tweaks - Thanks, Rynfri!

---

# MOM 2.0.1 (Updated - 03.08.2026)
...
[SLPP Talk During Sex](https://www.nexusmods.com/skyrimspecialedition/mods/173592?tab=files&file_id=726233&nmm=1) Thanks, [Juntii](https://www.nexusmods.com/profile/Juntii?gameId=1704)!  
...
[Dynamic Feminine Female Modesty Animations OAR](https://www.nexusmods.com/skyrimspecialedition/mods/104374?tab=files&file_id=724338&nmm=1)  
[Advanced Nudity Detection](https://www.nexusmods.com/skyrimspecialedition/mods/165289)  
[Fertility Mode Reloaded](https://www.nexusmods.com/skyrimspecialedition/mods/165569)  
[Swiftly Order Squad](https://www.nexusmods.com/skyrimspecialedition/mods/63259?tab=files&file_id=716679&nmm=1)  
[Billyy's SLAL Animations 10.0 SE](https://www.loverslab.com/files/file/3999-billyys-slal-animations-2026-3-5/)  
...
[No Overpenetration](https://www.loverslab.com/files/file/10339-no-overpenetration-se)  
...
- Added/edited the following custom patches  
   ...
   - `Relics of Order.esp`  
   - `MOM - Modded Weapon Consistency Patch.esp`  
...
- Removed the following custom patches  
   ...
   - `MOM - Landscape Patch - 7k Steps.esp`  
   - `MOM - Landscape Patch - Alchemists Shack.esp`  
   - `MOM - Landscape Patch - Dawnstar Navmesh.esp`  
   - `MOM - Landscape Patch - Dayspring Canyon.esp`  
   - `MOM - Landscape Patch - Dragon Bridge.esp`  
   - `MOM - Landscape Patch - Elysium Estate.esp`  
   - `MOM - Landscape Patch - Falkreath Hold.esp`  
   - `MOM - Landscape Patch - Falkreath Longhouse Exterior.esp`  
   - `MOM - Landscape Patch - Granite Hill.esp`  
   - `MOM - Landscape Patch - Gray Fox Cowl.esp`  
   - `MOM - Landscape Patch - Hillgrund's Tomb.esp`  
   - `MOM - Landscape Patch - Honningbrew Bridge Fix.esp`  
   - `MOM - Landscape Patch - Ivarstead.esp`  
   - `MOM - Landscape Patch - Karthwasten.esp`  
   - `MOM - Landscape Patch - Levelers Tower.esp`  
   - `MOM - Landscape Patch - Little Vivec.esp`  
   - `MOM - Landscape Patch - Markarth Outskirts.esp`  
   - `MOM - Landscape Patch - Raven Rock.esp`  
   - `MOM - Landscape Patch - Riften Outskirts.esp`  
   - `MOM - Landscape Patch - Riverwood Hill.esp`  
   - `MOM - Landscape Patch - Riverwood Tree.esp`  
   - `MOM - Landscape Patch - Riverwood.esp`  
   - `MOM - Landscape Patch - Robbers Gorge.esp`  
   - `MOM - Landscape Patch - Rorikstead.esp`  
   - `MOM - Landscape Patch - Solitude Arch.esp`  
   - `MOM - Landscape Patch - Solitude Underwater.esp`  
   - `MOM - Landscape Patch - The Pale.esp`  
   - `MOM - Landscape Patch - The Shadow Stone.esp`  
   - `MOM - Landscape Patch - Whiterun Exterior Carriage.esp`  
   - `MOM - Landscape Patch - Whiterun Outskirts.esp`   
   - `MOM - Northern Roads Grass Patch - Frozen Pool Fix.esp`  
...
- Changed NPC Defeat percentage to 100% by default in Acheron MCM Recording to fix Hunter's Pride issue  
- Fixed ultrawide MCM Recordings to play after the Scrolls of Love MCM Recording  
...
- Put SSSO3 `settings.nlset` into `MOM - MCM and INI Settings` so all settings are setup by default  

---

# MOM 1.0.3 (Updated - 02.10.2026)
...
[Immersive Wenches SE 2 - Sexlab patch](https://www.nexusmods.com/skyrimspecialedition/mods/152982)  
[The Naked Dragon (Sexlab)](https://www.nexusmods.com/skyrimspecialedition/mods/94940?tab=files&file_id=642393&nmm=1)  
[The Nasty Pine - (Sexlab)](https://www.nexusmods.com/skyrimspecialedition/mods/138504?tab=files&file_id=639560&nmm=1)  
[The Rift's Rest (Sexlab)](https://www.nexusmods.com/skyrimspecialedition/mods/75649?tab=files&file_id=581661&nmm=1)  
...
[Immersive wenches - Sexlab patch](https://www.nexusmods.com/skyrimspecialedition/mods/70349)  
...
Changed version of [FunnyBizness (v25) SLAL Pack by Shashankie v12.0](https://www.loverslab.com/files/file/2702-funnybizness-v25-slal-pack-by-shashankie/) to resolve download errors
...
- Added 3BBB.ini file to `MOM - MCM and INI Settings` with appropriate keybinds set by default (resolves issue with overlapping keybinds)

---

# MOM 1.0.0 (Updated - 02.08.2026)
...
[M2M Animations for SLAL 20210222](https://www.loverslab.com/files/file/16160-m2m-animations-for-slal/)  
[The loyal maid - Sexlab and Flower Girls](https://www.nexusmods.com/skyrimspecialedition/mods/80603)  
[Shadowmans NPCs 3 - Horny MILF Carlotta - Voiced Sexlab Addon](https://www.nexusmods.com/skyrimspecialedition/mods/74082)  
[Shadowmans NPCs 8 - Endarie Tsundere - Sexlab Addon](https://www.nexusmods.com/skyrimspecialedition/mods/76553)  
[Shadowmans NPCs 12 - Sex parties - Sexlab Addon](https://www.nexusmods.com/skyrimspecialedition/mods/79249)  
