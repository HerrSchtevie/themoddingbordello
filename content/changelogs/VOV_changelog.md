...
- Added/edited the following custom patches: 
   ...
   - `VOV - MCM and INI Settings\Scripts\VOV_MCMSettingsInit.pex`
...
- Added/edited the following custom patches: 
   - `VOV - MCM Settings.esp` - replaces the historically unreliable MCM Recordings. The recordings stay installed as an optional tool for reverting to stock list settings.
...
- Removed `VOV - TRX Futanari BNP Frostnip textures` in favor of [Rynfri's](https://www.nexusmods.com/profile/Rynfri) new Nexus version  
