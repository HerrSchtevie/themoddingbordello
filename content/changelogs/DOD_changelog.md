...
- Added/edited the following custom patches: 
   ...
   - `DOD - MCM and INI Settings` - VSync is now on by default in `ssedisplaysettings.ini`  
...
The Lord's Vision (ENB) profile is gone. DOD now ships a single Community Shaders profile, `Diaries of Dibella`, and the Lord's Vision tool outputs went with it. ENB presets are still available through Effects 11; see `ENB Presets and DLSS 5 - Setup Instructions` in MO2.
...
- Added/edited the following custom patches: 
   ...
   - `DOD - BHKS Lux Patch` - Thanks, [Rynfri](https://www.nexusmods.com/profile/Rynfri)!  
   ...
   - `ENB Presets and DLSS 5 - Setup Instructions`  
   - `DOD - MCM and INI Settings`  
   - `SOS - DALC Fix Customization`  
   - `SOS - Forms of Order`  
   - `DLSS 5 - ReShade Bridge`  
- Removed the following custom patches:
   - `Display Tweaks for CS Upscaling` - its five upscaling keys now live in `DOD - MCM and INI Settings`
...
[Alpia Scribbles Slavetats Pack](https://www.loverslab.com/files/file/30951-alpia-scribbles-slavetats-pack/) (Main Pack, Riek, Orc, and RaceMenu plugins) - Requires 4 new manual downloads from [DOD Manual Downloads](https://www.themoddingbordello.com/modlists/dod/manual-downloads)  
...
- Added/edited the following custom patches: 
   - `SOS - Merged Patches FOMOD`  
   - `JOJ - Outfit Distribution`  
   - `DOD - Armour WAAT Patch 0`
   - `DOD - Armour Waat Patch 3`
   - `DOD - Armour Waat Patch 4`  
   - `DOD - Armour WAAT Patch 5`
...
[SexLab P+](https://www.loverslab.com/files/file/25318-sexlab-p/) - Requires new manual download from [DOD Manual Downloads](https://www.themoddingbordello.com/modlists/dod/manual-downloads)  
...
# DOD 1.0.0-Live (Updated - 04.04.2026)
...
- Added/edited the following custom patches
   - `DOD - TRX Futanari BNP Frostnip textures`  
   - `JOJ - Outfits.esp`  
   - `HOH - Gameplay Edits.esp`  
...
- Updated `DOD - Armour WAAT Patch 5.esp` to correct misassignment of Adventurer's Tunic crafting recipes  
- Fixed issues with OBody not working with certain BD's Armor replacers  
- Added `settings.ini` to `DOD - MCM & INI Settings\MCM\config\Trade & Barter`  
...
- Added VRAMr `Exclusions.mod` to `DOD - MCM and INI Settings` and added in Vampire Lord Overhaul textures that cause issues when run through VRAMr  
