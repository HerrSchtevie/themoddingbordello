...
<td align="center">
<a href="https://loadorderlibrary.com/lists/visions-of-vaermina"><strong>Load Order Library</strong></a><br>
...
🎮 **System Requirements for Visions of Vaermina - 🛡️ Lord’s Vision Profile** 🎮
...
| **Disk Space**| ~162GB Download / ~268GB Installed / ~430GB Total       | ~162GB Download / ~268GB Installed / ~430GB Total    |

---

🎮 **System Requirements for Visions of Vaermina - 🛡️ Performance Profile** 🎮
...
2. **Prepare a Clean Skyrim AE Installation**  
   ...
   - **Launch Skyrim AE once through Steam** to allow all Creation Club content to download.  
     Do **not** change any settings or start a game — just reach the main menu, download the Creation Club content via the popup, then close it.
   - Install the **Skyrim Special Edition Creation Kit** from the *Software* section in your Steam Library. (If your library is filtered to just Games, the SSE Creation Kit will not be visible.)  
     ...
     ❌ **DO NOT SKIP THIS STEP**. Creation Kit is not the same as Creation Club. You must have BOTH Creation Kit AND Creation Club installed to proceed.
...
5. **Select the Modlist**
   ...
   - Choose:
     - A **Download Location** – where Wabbajack will store mod archives. Select the `\downloaded mods` directory from step 3. 
       📦 Requires approximately **283 GB of free space**.
     - An **Installation Location** – where the modlist will be fully installed and run from. Create a `\VOV` directory in the \modlists folder from step 3.
       💾 Requires approximately **594 GB of free space**.  
       ⚠️ **This must be on an Internal SSD** for performance and stability.
...
- To address this, we include Skyrim Save System Overhaul 3 (SSSO3). This mod ensures that saves are only written when the engine can safely create a clean file, greatly reducing the chance of progressive corruption. Refer to our [Gameplay Guide](https://github.com/HerrSchtevie/Scrolls-of-Schtevie/wiki/JOJ-Gameplay-Guide#-skyrim-save-system-overhaul-3) for configuration instructions.
...
- [🧭 JOJ Gameplay Guide](JOJ-Gameplay-Guide)  
...
- **Q: Where do I go for support?**  
  A: Visit the Wabbajack Discord or Visions of Vaermina Discord for assistance.
