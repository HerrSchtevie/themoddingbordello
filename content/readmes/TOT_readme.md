...
| **Disk Space**| ~255GB Download / ~468GB Installed / ~723GB Total       | ~255GB Download / ~468GB Installed / ~723GB Total    |
...
5. **Select the Modlist**
   ...
   - Choose:
     ...
     - An **Installation Location** – where the modlist will be fully installed and run from. Create a `\TOT` directory in the `\modlists` folder from step 3.  
       Requires approximately **468 GB of free space**.  
...
1. Delete the ENB Cache in your overwrite folder (e.g. `D:\modlists\TOT\overwrite`).
...
### 3. Configure TOT to Your Preferences
