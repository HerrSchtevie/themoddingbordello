...
<tr>
<td align="center">
<a href="https://www.nexusmods.com/skyrimspecialedition/mods/154277"><strong>View on Nexus Mods</strong></a><br>
View the Modlist
</td>

<td align="center">
<a href="/modlists/tot/changelog"><strong>View Changelog</strong></a><br>
See Version History
</td>

<td align="center">
<a href="/modlists/tot/load-order"><strong>Load Order</strong></a><br>
...
- **Community Shaders, with ENB on Tap:**  
  TOT ships a single profile, `Tomes of Talos`, built on Community Shaders. Five ENB presets and two card-specific DLSS 5 add-ons ride along disabled, ready to switch on under Rule 11; see ENB Presets and DLSS 5 in the post-installation steps.
...
- **Comprehensive NPC Overhauls:**  
  Nearly every NPC in Skyrim has been visually enhanced using a curated blend of ColdSun's Visions, Pandorables NPCs, Sons of Nirn, and other top-quality overhaul mods — all seamlessly integrated through a custom NPC Plugin Chooser 2 merge for maximum compatibility and consistency.
...
| **Disk Space**| ~248GB Download / ~426GB Installed / ~674GB Total    | ~248GB Download / ~426GB Installed / ~674GB Total    |
...
3. **Create Folders and Defender Exceptions**
   ...
   - **Important:** do not bury your `\modlists` folder deep in your directory system. If the absolute path to your list install is much longer than `D:\modlists\TOT\` you may encounter cryptogenic errors resulting from overlong file paths.
...
5. **Select the Modlist**
   ...
   - Choose:
     - A **Download Location** – where Wabbajack will store mod archives. Select the `\downloaded mods` directory from step 3.  
       Requires approximately **248 GB of free space**.
     - An **Installation Location** – where the modlist will be fully installed and run from. Create a `\TOT` directory in the `\modlists` folder from step 3.  
       Requires approximately **426 GB of free space**.  
...
### 2. Configure TOT to Your Preferences
...
TOT runs Community Shaders. Two optional visual add-ons ship with the list, both disabled by default, and both fall under Rule 11. They can be used together.
...
>
> Do **not** click **"Unlock"** in Mod Organizer 2 while Tomes of Talos is launching or running.
>
...
- To address this, we include Skyrim Save System Overhaul 3 (SSSO3). This mod ensures that saves are only written when the engine can safely create a clean file, greatly reducing the chance of progressive corruption. Refer to our [Gameplay Guide](/modlists/tot/gameplay-guide#skyrim-save-system-overhaul-3) for configuration instructions.
...
- Loading during play is even riskier than saving. When you reload mid-session, leftover data from the current session mixes with the new one; then, the next time you save, that bad data is baked into your save file from then on.
  ...
  - Again, this guidance applies to all Skyrim configurations, not just TOT.
...
> **Disclaimer:** these guides were originally written for *Journals of Jyggalag* and may reference features, mechanics, or mods not present in **Tomes of Talos**.  
> However, much of the content — including tool instructions, NPC customization, and gameplay tips — still applies and can be used as a helpful reference when playing TOT.  
> Use your judgment when following these guides and disregard anything specific to JOJ-exclusive content.

For more information on controller support, NPC management, and running essential tools, check out the following:

- [TOT Gameplay Guide](/modlists/tot/gameplay-guide): key gameplay systems, progression, mechanics, and builds.
...
Before you change anything, copy the shipped profile in MO2 (profile dropdown, **Manage**, select `Tomes of Talos`, **Copy**) and make every edit in the copy. The untouched original is your safe fallback if something breaks.
...
- [Tomes of Talos on Nexus Mods](https://www.nexusmods.com/skyrimspecialedition/mods/154277)
...
Whether you're here for the lore, the visuals, or the chaos — I truly appreciate you choosing TOT as your journey through Skyrim.
