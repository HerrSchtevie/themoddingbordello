...
<tr>
<td align="center">
<a href="https://discord.gg/themoddingbordello"><strong>Join our Discord</strong></a><br>
Join the Community
</td>

<td align="center">
<a href="https://www.reddit.com/r/themoddingbordello/"><strong>Join our Subreddit</strong></a><br>
Public Discussion Hub
</td>

<td align="center">
<a href="https://www.youtube.com/@herrschtevie"><strong>Watch on YouTube</strong></a><br>
Shorts & Dev Clips
</td>

<td align="center">
<a href="https://www.twitch.tv/herrschtevie"><strong>Watch on Twitch</strong></a><br>
...
<tr>
<td align="center">
<a href="https://www.nexusmods.com/skyrimspecialedition/mods/156694"><strong>View on Nexus Mods</strong></a><br>
View the Modlist
</td>

<td align="center">
<a href="/modlists/dod/changelog"><strong>View Changelog</strong></a><br>
See Version History
</td>

<td align="center">
<a href="/modlists/dod/load-order"><strong>Load Order</strong></a><br>
View Full Load Order
</td>

<td align="center">
<a href="https://ko-fi.com/herrschtevie"><strong>Support on Ko-fi</strong></a><br>
Buy Me a Coffee
</td>
</tr>
...
Diaries of Dibella (DOD) is a Skyrim modlist designed for mature audiences. It includes NSFW content, SexLab integration, and other adult-oriented modifications. Ensure you are legally allowed to access such content in your region before proceeding.
...
- **Community Shaders, with ENB on Tap:**  
  DOD ships a single profile, `Diaries of Dibella`, built on Community Shaders. Five ENB presets and two card-specific DLSS 5 add-ons ride along disabled, ready to switch on under Rule 11; see ENB Presets and DLSS 5 in the post-installation steps.

- **Quest Mods:**  
  DOD includes a massive lineup of lore-rich, fully patched quests that expand Skyrim's world with new factions, dungeons, and narratives. Major entries include:  
...
- **Combat & Perks:**  
  ...
  Perk overhaul is Vokrii, paired with Synergy - Skills and Perks Reimagined and SALSa skill-access locking, with support from Mannaz, Freyr, Sacrilege, Growl, and Devotion.
...
- **NSFW & SexLab Integration:**  
  DOD integrates SexLab P+, OBody, HIMBO, and 3BA with immersive balance. All adult content is carefully implemented.
...
3. **Create Folders and Defender Exceptions**
   ...
   - **Important:** do not bury your `\modlists` folder deep in your directory system. If the absolute path to your list install is much longer than `D:\modlists\DOD\` you may encounter cryptogenic errors resulting from overlong file paths.
...
4. **Manually Download Required LoversLab & External Files (Required)**
   ...
   - If Wabbajack encounters a missing file, **it will explicitly tell you which file is missing**.
     - Refer back to the [DOD Manual Downloads](/modlists/dod/manual-downloads) page if needed.
     - Copy the URL shown in Wabbajack into your browser.
     - Download the correct file.
     - Place it into the DOD downloads folder.
     - Resume the installation.
   - **Double-check that all required manual files listed on the [DOD Manual Downloads](/modlists/dod/manual-downloads) page are present before asking for support.**

> **SexLab / LoversLab modlists are notoriously difficult to download** due to site restrictions, mirrors, and login requirements. This is normal and expected.
...
5. **Launch Wabbajack**
   ...
   - In the **upper-left corner**, enable both:
     ...
     - **Show NSFW Lists**
   - Use the search bar to find **Diaries of Dibella**.

6. **Select the Modlist**
...
7. **Start Installation**
   ...
   - Refer to the [DOD Manual Downloads](/modlists/dod/manual-downloads) page, download the missing file, place it into the DOD downloads folder, and resume the installation.
...
>
> **Diaries of Dibella** is *not* like the other Bordello lists.  
...
9. **Having Issues? Run Through This Checklist First**
...
- Navigate to your **Diaries of Dibella installation folder**.
...
### 2. Configure DOD to Your Preferences

Before diving into your playthrough, take a moment to configure the list to match your setup. Whether you're using ultrawide resolutions or a controller, Diaries of Dibella is built to adapt — but it expects you to pick your setup and stick with it.

> **Before you change anything beyond the steps on this page (Rule 11):** copy the shipped profile first. Open the profile dropdown at the top of MO2's left pane, click **Manage**, select `Diaries of Dibella`, click **Copy**, and make every edit in the copy. The untouched original is your safe fallback if something breaks. The [SOS Rule 11 Guide](/guides/sos-rule-11-guide) has the full procedure.

---

### Widescreen & Resolution Support

Diaries of Dibella includes full widescreen support with UI presets for all major aspect ratios. These options are found near the **bottom of MO2** under the **`Resolution Presets`** separator (highlighted in blue).

- **Always enabled:**
  - `DOD - Core UI`

- **Choose one (and only one) based on your monitor:**
  - `DOD - 21x9 UI Patch` for ultrawide (21:9)
  - `DOD - 32x9 UI Patch` for super ultrawide (32:9)

![image](https://github.com/user-attachments/assets/3d46ed5b-3e3a-4728-90e9-1f5d4406a5fe)
...
DOD runs Community Shaders. Two optional visual add-ons ship with the list, both disabled by default, and both fall under Rule 11. They can be used together.
...
Controller support is fully integrated into DOD, but all related mods are **disabled by default** so players can opt in manually. To enable controller support:
...
2. **Enable all of the following mods**:
   ...
   ![image](https://github.com/user-attachments/assets/d1374c67-3468-487a-bb94-d1a9e202afe3)
...
>
> Do **not** click **"Unlock"** in Mod Organizer 2 while Diaries of Dibella is launching or running.
>
...
- Spend at least a few minutes on your character (or simply wait) before confirming.
- Consider saving your appearance as a RaceMenu preset in case you ever need to recreate the character.

**Stay in the starting room**

- Once you enter the game:
  - Your character will load into a small setup room.
  - A **DOD Welcome message** will pop up immediately. It explains that the list is performing initial setup in the background and that **you must wait**.
...
> More information about the gameplay and NSFW mods can be found in the [Gameplay Guide](/modlists/dod/gameplay-guide).

- **Hotkey Reminder** (press **F11** in-game to view all keybinds).

![image](https://github.com/user-attachments/assets/a044ea41-2faa-4bf5-b59d-e0b00ed98962)
...
- Loading during play is even riskier than saving. When you reload mid-session, leftover data from the current session mixes with the new one; then, the next time you save, that bad data is baked into your save file from then on.
  ...
  - Again, this guidance applies to all Skyrim configurations, not just DOD.

- To reduce the number of reloads you'll need to perform, the list includes the Acheron death alternative mod. While it won't prevent every death, it will minimize situations where you're forced to reload. Feel free to use a different death alternative if you prefer.
...
- [DOD Gameplay Guide](/modlists/dod/gameplay-guide): key gameplay systems, progression, mechanics, and builds.
...
By choosing to modify or tweak **Diaries of Dibella (DOD)** in any way — whether by adding mods, changing load order, editing settings, or rebuilding components — you are doing so at your own risk.
...
Before you change anything, copy the shipped profile in MO2 (profile dropdown, **Manage**, select `Diaries of Dibella`, **Copy**) and make every edit in the copy. The untouched original is your safe fallback if something breaks.
...
- [Diaries of Dibella on Nexus Mods](https://www.nexusmods.com/skyrimspecialedition/mods/156694)
...
Thank you for taking the time to install and experience **Diaries of Dibella**. This project is a passion-driven labor of love built on the shoulders of an incredible modding community.

Whether you're here for the lore, the visuals, the chaos, or the adult content — I truly appreciate you choosing DOD as your journey through Skyrim.
