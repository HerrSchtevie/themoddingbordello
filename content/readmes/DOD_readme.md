...
🎮 **System Requirements for Diaries of Dibella - 🛡️ Lord’s Vision Profile** 🎮
...
| **Disk Space**| ~290GB Download / ~628GB Installed / ~918GB Total       | ~290GB Download / ~628GB Installed / ~918GB Total  |

---

🎮 **System Requirements for Diaries of Dibella - 🛡️ Performance Profile** 🎮
...
3. **Create folders and Defender exceptions**
   ...
   - ⚠️ Important: Do not bury your `\modlists` folder deep in your directory system. If the absolute path to your list install is much longer than `D:\modlists\DOD\` you may encounter cryptogenic errors resulting from overlong file paths.
...
### ⚠️ **SexLab / LoversLab modlists are notoriously difficult to download** due to site restrictions, mirrors, and login requirements. This is normal and expected.
...
6. **Select the Modlist**
   ...
   - Choose:
     - A **Download Location** – where Wabbajack will store mod archives.  
       ...
       📦 Requires approximately **290 GB of free space**.
     - An **Installation Location** – where the modlist will be fully installed and run from.  
       Create a `\DOD` directory in the `\modlists` folder from Step 3.  
       💾 Requires approximately **628 GB of free space**.  
       ⚠️ **This must be on an SSD** for performance and stability.  
       > SSDs perform *very poorly* when over 85–90% capacity. Do not attempt to install DOD on a drive that will be nearly full.
...
>  
> **Diaries of Dibella** is *not* like the other Scrolls of Schtevie lists.  
...
**Order of operations for a smooth new game:**

**Stay in the starting room**  

- Once you enter the game:
  - Your character will load into a small setup room.
  - A **DOD Welcome message** will pop up immediately — this explains that the list is performing initial setup in the background and that **you must wait**.
...
- Visit the Wabbajack Discord or The Modding Bordello Discord for assistance.
...
- **Q: Where do I go for support?**  
  A: Visit the Wabbajack Discord or The Modding Bordello Discord for assistance.
