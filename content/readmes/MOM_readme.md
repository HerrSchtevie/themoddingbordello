...
🎮 **System Requirements for Mantras of Mara - 🛡️ Lord’s Vision Profile** 🎮
...
| **Disk Space**| ~289GB Download / ~630GB Installed / ~919GB Total       | ~289GB Download / ~630GB Installed / ~919GB Total  |

---

🎮 **System Requirements for Mantras of Mara - 🛡️ Performance Profile** 🎮
...
3. **Create folders and Defender exceptions**
   ...
   - ⚠️Important: Do not bury your `\modlists` folder deep in your directory system. If the absolute path to your list install is much longer than `D:\modlists\MOM\` you may encounter cryptogenic errors resulting from overlong file paths.
...
6. **Select the Modlist**
   ...
   - Choose:
     - A **Download Location** – where Wabbajack will store mod archives.  
       ...
       📦 Requires approximately **289 GB of free space**.
     - An **Installation Location** – where the modlist will be fully installed and run from.  
       Create a `\MOM` directory in the `\modlists` folder from Step 3.  
       💾 Requires approximately **630 GB of free space**.  
       ⚠️ **This must be on an SSD** for performance and stability.  
       > SSDs perform *very poorly* when over 85–90% capacity. Do not attempt to install MOM on a drive that will be nearly full.
...
- Once you enter the game:
  ...
  - A **MOM Welcome message** will pop up immediately — this explains that the list is performing initial setup in the background and that **you must wait**.
