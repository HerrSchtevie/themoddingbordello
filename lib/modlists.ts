...
export const modlists: ModlistMeta[] = [
  ...
  },
  {
    ...
    pluginCounts: {
      lv: {
        all: { active: 3744, total: 3744 },
        esms: { active: 61, total: 61 },
        esps: { active: 170, total: 170 },
        esmsPlusEsps: { active: 231, total: 231 },
        esls: { active: 3513, total: 3513 },
      },
      perf: {
        all: { active: 3750, total: 3752 },
        esms: { active: 61, total: 61 },
        esps: { active: 172, total: 172 },
        esmsPlusEsps: { active: 233, total: 233 },
        esls: { active: 3517, total: 3519 },
      },
    },
  },
  {
